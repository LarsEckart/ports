...
- Stack: Go 1.27.0 CLI named `ports`; entrypoint is `main.go`, command registration lives in `cmd/`, OS inspection lives in `scanner/`, and terminal rendering lives in `render/`.
